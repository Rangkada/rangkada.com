          ...
          <div className="container pb-16 md:pb-24 lg:pb-32">
            <div className="max-w-5xl">
              ...
              <Link onClick={handleClickApply} href="/alpha-partners/apply">
                <button className="group relative inline-flex items-center gap-3 bg-primary hover:bg-primary/90 text-white font-semibold text-lg md:text-xl px-8 md:px-10 py-5 md:py-6 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/50">
